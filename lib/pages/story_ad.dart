...
class StoryAd extends StatefulWidget {
  const StoryAd({Key? key}) : super(key: key);

  @override
  State<StoryAd> createState() => _StoryAdState();
}

class _StoryAdState extends State<StoryAd> {
  String? dropvalue;
