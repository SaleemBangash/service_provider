...
import 'package:service_provider/pages/drawer/change_language2.dart';
import 'package:service_provider/pages/drawer/reg_dialogue.dart';
import 'package:service_provider/pages/login_screen.dart';
import 'package:service_provider/pages/register_screen.dart';
import 'package:service_provider/pages/search.dart';
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: ((context) => RegDialogue())));
              },
              child: DrawerList(
