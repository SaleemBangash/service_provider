...
class NormalBottomBar extends StatefulWidget {
  // final Widget body;
  ...
  @override
  _NormalBottomBarState createState() => _NormalBottomBarState();
}

class _NormalBottomBarState extends State<NormalBottomBar> {
